...
if not exist "%ProgramData%\Microsoft\Windows\Start Menu\Programs\QGIS\%QGIS_TEXT%.lnk" (
   nircmd shortcut """%OSGEO4W_ROOT%""\bin\qgis-ltr-start.bat" "%ProgramData%\Microsoft\Windows\Start Menu\Programs\QGIS" "%QGIS_TEXT%" "" """%OSGEO4W_ROOT%""\apps\qgis-ltr\icons\QGIS.ico" "0" "min" """%OSGEO4W_ROOT%""\bin" ""
   )
...
if not exist "%PUBLIC%\Desktop\%QGIS_TEXT%.lnk" (
   nircmd shortcut """%OSGEO4W_ROOT%""\bin\qgis-ltr-start.bat" "%PUBLIC%\Desktop" "%QGIS_TEXT%" "" """%OSGEO4W_ROOT%""\apps\qgis-ltr\icons\QGIS.ico" "0" "min" """%OSGEO4W_ROOT%""\bin" ""
   )
